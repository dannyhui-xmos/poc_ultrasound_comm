...
union UStg2_filter_state {
  ...
  int32_t filter_state_df_1[MIC_ARRAY_CONFIG_MIC_COUNT][MIC_ARRAY_96K_STAGE_2_TAP_COUNT];
};
...
union UPdmRx_out_block {
  ...
  uint32_t out_block_df_1[MIC_ARRAY_CONFIG_MIC_COUNT][1];
};
...
union UPdmRx_out_block_double_buf {
  ...
  uint32_t __attribute__((aligned (8))) out_block_double_buf_df_1[2][MIC_ARRAY_CONFIG_MIC_IN_COUNT * 1];
};
...
inline const uint32_t* stage_1_filter(unsigned stg2_dec_factor) {
  ...
  return (stg2_dec_factor == 1) ? &stage1_96k_coefs[0] : ((stg2_dec_factor == 2) ? &stage1_48k_coefs[0] : ((stg2_dec_factor == 3) ? &stage1_32k_coefs[0] : &stage1_coef[0]));
}
inline const int32_t* stage_2_filter(unsigned stg2_dec_factor) {
    return (stg2_dec_factor == 1) ? &stage2_96k_coefs[0] : ((stg2_dec_factor == 2) ? &stage2_48k_coefs[0] : ((stg2_dec_factor == 3) ? &stage2_32k_coefs[0] : &stage2_coef[0]));
}
inline const right_shift_t stage_2_shift(unsigned stg2_dec_factor) {
    return (stg2_dec_factor == 1) ? stage2_96k_shift : ((stg2_dec_factor == 2) ? stage2_48k_shift : ((stg2_dec_factor == 3) ? stage2_32k_shift : stage2_shr));
}
inline unsigned stage_2_num_taps(unsigned stg2_dec_factor) {
    return (stg2_dec_factor == 1) ? MIC_ARRAY_96K_STAGE_2_TAP_COUNT : ((stg2_dec_factor == 2) ? MIC_ARRAY_48K_STAGE_2_TAP_COUNT : ((stg2_dec_factor == 3) ? MIC_ARRAY_32K_STAGE_2_TAP_COUNT : STAGE2_TAP_COUNT));
}
inline int32_t* stage_2_state_memory(unsigned stg2_dec_factor) {
   return (stg2_dec_factor == 1) ? (int32_t*)stg2_filter_state_mem.filter_state_df_1 \
            : (stg2_dec_factor == 2) ? (int32_t*)stg2_filter_state_mem.filter_state_df_2 \
...
inline uint32_t* get_pdm_rx_out_block(unsigned stg2_dec_factor) {
   return (stg2_dec_factor == 1) ? (uint32_t*)pdm_rx_out_block.out_block_df_1 \
            : (stg2_dec_factor == 2) ? (uint32_t*)pdm_rx_out_block.out_block_df_2 \
...
inline uint32_t* get_pdm_rx_out_block_double_buf(unsigned stg2_dec_factor) {
   return (stg2_dec_factor == 1) ? (uint32_t*)pdm_rx_out_block_double_buf.out_block_double_buf_df_1 \
            : (stg2_dec_factor == 2) ? (uint32_t*)pdm_rx_out_block_double_buf.out_block_double_buf_df_2 \
            : ((stg2_dec_factor == 3) ? (uint32_t*)pdm_rx_out_block_double_buf.out_block_double_buf_df_3 \
            : (uint32_t*)pdm_rx_out_block_double_buf.out_block_double_buf_df_6);
}
